...
const loadTicket = async () => {
  ...
  try {
    const response = await apiGet(`/admin/tickets/${props.ticketId}`);
...
const loadConversation = async () => {
  ...
  try {
    const response = await apiGet(`/admin/tickets/${props.ticketId}/conversation`);
    const data = await response.json().catch(() => null);
...
const loadAttachments = async () => {
  ...
  try {
    const response = await apiGet(`/admin/tickets/${props.ticketId}/attachments`);
    const data = await response.json().catch(() => null);
...
const handleReply = async () => {
  ...
  try {
    const response = await apiPost(`/admin/tickets/${props.ticketId}/reply`, {
